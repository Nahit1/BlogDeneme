$(document).ready(function () {
    ...
    $('#categoriesTable').DataTable({
                                ...
                                $.each(categoryListDto.Categories.$values, function (index, category) {
                                    tableBody += `<tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button class="btn-danger btn-sm btn-delete" data-id="${category.Id}"><span class="fas fa-minus-circle"></span></button>
                                                                </td>
                                                            </tr>`
                                });
        ...
        language:
        {
            ...
            "searchBuilder": {
                ...
                "title": {
                    "0": "Arama Oluşturucu",
                    "_": "Arama OluUrltActionActionActionurucu (%d)"
                }
            },
            "searchPanes": {
                    ...
                    if (isValid) {
                        ...
                        const newTableRow = `<tr name="${categoryAddAjaxModel.CategoryDto.Category.Id}">
                                                            ...
                                                            <td>
                                                                ...
                                                                <button class="btn-danger btn-sm btn-delete" data-id="${categoryAddAjaxModel.CategoryDto.Id}"><span class="fas fa-minus-circle"></span></button>
                                                            </td>
                                                        </tr>`;
    ...
    $(document).on('click', '.btn-delete', function (event) {
        ...
        //td'nin ikinci elemanını almak için
                ...
                if (isValid) {
                    ...
                    const newTableRow = `<tr name="${categoryUpdateAjaxModel.CategoryDto.Category.Id}">
                                             ...
                                             <td>
                                                 ...
                                                 <button class="btn-danger btn-sm btn-delete" data-id="${categoryUpdateAjaxModel.CategoryDto.Id}"><span class="fas fa-minus-circle"></span></button>
                                             </td>
                                         </tr>`;
