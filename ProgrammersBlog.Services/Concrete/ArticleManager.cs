...
namespace ProgrammersBlog.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<Result> Add(ArticleAddDto articleAddDto, string createdBName)
        {
            var article = _mapper.Map<Article>(articleAddDto);
            article.CreatedByName = createdBName;
        ...
        public async Task<IDataResult<ArticleDto>> Get(int articleId)
        {
            ...
            return new DataResult<ArticleDto>(ResultStatus.Error, "Böyle bir kayıt bulunamadı", null);
        ...
        public async Task<IDataResult<ArticleListDto>> GetAll()
        {
            ...
            return new DataResult<ArticleListDto>(ResultStatus.Error, "Böyle bir kayıt bulunamadı", null);
        }
        ...
        {
            var articles = await _unitOfWork.Articles.GetAllAsync(a => a.IsDeleted == false, ar => ar.User, ar => ar.Category);
